...
The new, clean repository was published publicly under `ricardoportoIE/gda-environmental-reporting-platform` on 2026-09-15 at the owner's explicit request. Its two initial commits were scanned before push; this did not modify any legacy refs or import legacy data. Archiving or rewriting the old repositories still requires the unresolved incident work above. The CI/CD workflow packages clean images when a version tag is pushed; no tag has been made.
